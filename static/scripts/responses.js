function getBotResponse(input) {
    ...
    if (input == "ya ada yang ingin saya tanyakan") {
        return "Baik, Saya informasikan terlebih dahulu bahwa program Ebot ini masih dalam tahap pengembangan, Jadi mohon maaf bila ada pertanyaan anda yang kami tidak mengerti dan tidak terjawab dikarenakan data yang kami peroleh masih terbatas.";
    } 
        ...
        return "Presiden pertama indonesia adalah ir. Soekarno, dan wakilnya adalah Muhammad Hatta";
    } 
